...
import prototype.utils.math import nwu2edn
import prototype.utils.math import euler2rot
...
class TestCamera(object):
    ...
    def check_features(self, dt, features, rpy, t, observed):
        # pre-check
        ...
        # projection matrix
        # projection_matrix(self.K, R, -R * t_edn, P)
